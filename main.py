...
st.set_page_config(page_title="TAILOR_NEWS", page_icon=img)
...
st.markdown("<h1 style='text-align: center; color: #F55F0E;'>TAILOR_NEWS</h1>", unsafe_allow_html=True)
...
with col1:
    st.write(" ")
    st.markdown(
        "<h3 style='text-align: center; color: #FFFFFF;'>TailorNews helps you to get a personalised newspaper \N{newspaper} emailed  to you instantly with links of the topic which interests you!</h3>",
...
if gauth != 2:
    st.sidebar.write("OR")
    choice = st.sidebar.selectbox('Login / SignUp to TailorNews ', ('Login', 'SignUp'))
